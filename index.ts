...
let menu: Beer[] = [
    { id: 0, name: "Peroni", price: 4.00 },
    { id: 1, name: "Ceres", price: 4.20 },
    { id: 2, name: "Heineken", price: 3.50 },
    { id: 3, name: "Ichnusa", price: 6.90 },
    { id: 4, name: "Corona", price: 4.00 }
]
...
function createNewBeer(name: string, price: number) {
    if (isFinite(price) && price > 0) {
        menu.push({ id: menu[menu.length - 1].id + 1, name: name, price: price });
    ...
    for (var beer of menu) {
        var li = `<li class="list-group-item d-flex justify-content-between align-item-start">
                    <div class="ms-2 me-auto">
                        ...
                        <div id="${beer.id}_description">è buona</div>
                    </div>
